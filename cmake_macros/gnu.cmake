if (CMAKE_SYSTEM_PROCESSOR MATCHES "^aarch64")
  string(APPEND CFLAGS "-mcmodel=small -I/global/cfs/projectdirs/m2136/backup/conda/envs/pytorch1/include/python3.11")
  string(APPEND FFLAGS "-mcmodel=small")
else()
  string(APPEND CFLAGS "-mcmodel=medium -I/global/cfs/projectdirs/m2136/backup/conda/envs/pytorch1/include/python3.11")
...
string(APPEND LDFLAGS " -fPIC  -dynamic -Wl,-rpath /global/cfs/projectdirs/m2136/backup/conda/envs/pytorch1/lib -L/global/cfs/projectdirs/m2136/backup/conda/envs/pytorch1/lib -lpython3.11")
if (compile_threaded)
