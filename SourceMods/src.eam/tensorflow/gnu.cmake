if (CMAKE_SYSTEM_PROCESSOR MATCHES "^aarch64")
  string(APPEND CFLAGS "-mcmodel=small -I/global/cfs/projectdirs/m2136/backup/conda/envs/tensorflow1/include/python3.10")
  string(APPEND FFLAGS "-mcmodel=small")
else()
  string(APPEND CFLAGS "-mcmodel=medium -I/global/cfs/projectdirs/m2136/backup/conda/envs/tensorflow1/include/python3.10")
...
string(APPEND LDFLAGS " -fPIC  -dynamic -Wl,-rpath /global/cfs/projectdirs/m2136/backup/conda/envs/tensorflow1/lib -L/global/cfs/projectdirs/m2136/backup/conda/envs/tensorflow1/lib -lpython3.10")
if (compile_threaded)
